...
/** Re-exported for this file's own test coverage — the real logic (and its rationale) lives in role-match.ts, shared with company-careers.ts. */
export const matchesQuery = matchesRoleQuery;
